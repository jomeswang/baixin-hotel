      ...
      wx.chooseImage({
        ...
        success: (res) => {
          ...
          wx.uploadFile({
            ...
            name: 'file',
            url: 'https://ht1.jomeswang.top/api/order/pic',
            success: res => {
              const data = "https://ht1.jomeswang.top/" + res.data.slice(4)
              this.setData({
          ...
          wx.requestPayment({
            ...
            success(res) {
              ...
              console.log('form发生了submit事件，携带数据为：', that.data.formList),
                // 计数器  类似 id
                wx.request({
                  url: 'https://ht1.jomeswang.top/api/order',
                  method: "GET",
                  header: {
                  ...
                  success: (res) => {
                    ...
                    wx.request({
                      url: 'https://ht1.jomeswang.top/api/order/new',
                      header: {
                        "x-access-token": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VybmFtZSI6Indhbmd4aW4iLCJpYXQiOjE1OTg0OTk1OTF9.89hr8flvp3L5-rsO182hLPUqzQTBC2x6relk7DipbrU"
                      },
                      method: "POST",
